...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Appointment.status'
        db.alter_column(u'appointments_appointment', 'status', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Appointment.status'
        db.alter_column(u'appointments_appointment', 'status', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Appointment.app_time'
        db.alter_column(u'appointments_appointment', 'app_time', self.gf('django.db.models.fields.TimeField')(max_length=50))

    models = {
        u'appointments.appointment': {
            'Meta': {'object_name': 'Appointment'},
            'app_length': ('django.db.models.fields.IntegerField', [], {}),
            'app_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
